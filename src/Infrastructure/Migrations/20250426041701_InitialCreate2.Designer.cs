...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250426041701_InitialCreate2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Entities.BreakFastOrDinnerMeal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("BreakFastOrDinnerMeals");
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.LunchMeal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<Guid>("CarbohydrateItemId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CarbohydrateItemId");

                    b.HasIndex("PlansId");

                    b.HasIndex("ProteinItemId");
            ...
            modelBuilder.Entity("Domain.Models.Entities.BreakFastOrDinnerMeal", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Entities.Plan", "Plan")
                        .WithMany("BreakFastOrDinnerMeals")
            ...
            modelBuilder.Entity("Domain.Models.Entities.LunchMeal", b =>
                {
                    b.HasOne("Domain.Models.Entities.Item", "CarbohydrateItem")
                        .WithMany()
                        .HasForeignKey("CarbohydrateItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.Entities.Plan", "Plans")
                        .WithMany("LaunchMeals")
                        .HasForeignKey("PlansId");

                    b.HasOne("Domain.Models.Entities.Item", "ProteinItem")
                        .WithMany()
                        .HasForeignKey("ProteinItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CarbohydrateItem");

                    b.Navigation("Plans");

                    b.Navigation("ProteinItem");
                });
            ...
            modelBuilder.Entity("Domain.Models.Entities.Plan", b =>
                {
                    b.Navigation("BreakFastOrDinnerMeals");

                    b.Navigation("LaunchMeals");
                });
