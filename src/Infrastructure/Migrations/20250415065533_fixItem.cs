...
namespace Infrastructure.Migrations
{
    ...
    public partial class fixItem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_Meals_MainItems_MainItemId", table: "Meals");
            ...
            migrationBuilder.DropTable(name: "MealSideItem");

            migrationBuilder.DropTable(name: "SideItems");

            migrationBuilder.DropIndex(name: "IX_Meals_MainItemId", table: "Meals");

            migrationBuilder.DropIndex(name: "IX_Ingredients_SideItemId", table: "Ingredients");

            migrationBuilder.DropColumn(name: "RecipeId", table: "RecipeIngredients");

            migrationBuilder.DropColumn(name: "MainItemId", table: "Meals");

            migrationBuilder.DropColumn(name: "SideItemId", table: "Ingredients");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "IsMainItem", table: "MainItems");
